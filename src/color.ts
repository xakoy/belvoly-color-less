...
class Color {
    ...
    alpha: number = 0
    value: any = null
    constructor(rgb: string | Array<number>, a?: number, originalForm?: any) {
    ...
    static fromKeyword = function(keyword: string) {
        let c;
        const key = keyword.toLowerCase();
        if (colors.hasOwnProperty(key)) {
            c = new Color((colors as any)[key].slice(1));
        }
